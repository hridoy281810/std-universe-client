...
import { TAdmin, TQueryParam, TStudent } from "../../../../typs";
...
const AdminData = () => {
  ...
  const {data: studentData,isLoading,isFetching} =  useGetAllAdminQuery([
    {name:'limit',value:4},
   ...
   render:(item)=>{
    return(
      <Space>
        ...
        <Link to={`/admin/update-admin-data/${item.key}`}><Button >Update</Button></Link>
